...
import example from "./img/reverseLL.jpg";
class LinkedList {
	value: number;
 ...
 * }
 */
// Do not edit function name function reverseLinkedList(head) {
...
export const reverseLinkedList: Problem = {
	...
	problemStatement: `<p class=mt-3>Given the <code>head</code>of a single linked list, 
    reverse the list, and return <em>the reversed list</em></p> `,
	examples: [
		{
			id: 0,
